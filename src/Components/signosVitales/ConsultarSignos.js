...
export default function ConsultarSignos() {
    ...
    <div>
      ...
      <div className="container main-body-signos">
        <div className="header-signos">
          <h1>Consultar signos vitales</h1>
        </div>
  ...
  function setReadOnlyInputs(){
    document.getElementById("scedula").readOnly = true;
    document.getElementById("sfecha").readOnly = true;
    document.getElementById("sfrecuencia_cardiaca").readOnly = true;
    document.getElementById("sglucemia").readOnly = true;
    document.getElementById("stemperatura").readOnly = true;
    document.getElementById("spresion_arterial").readOnly = true;
    document.getElementById("srespondable").readOnly = true;
    document.getElementById("sturno").readOnly = true;
    document.getElementById("sfrecuencia_respirtaria").readOnly = true;
    document.getElementById("saturacion_oxigeno").readOnly = true;
  }
